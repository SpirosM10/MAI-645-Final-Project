...
class acLSTM(nn.Module):
    ...
    def calcualte_loss_angle(self, out_seq, groundtruth_seq): #strange results when using this
...
read_weight_path=""
write_weight_folder="../train_weight_aclstm_salsa_6d/"
write_bvh_motion_folder="../train_tmp_bvh_aclstm_salsa_6d/"
dances_folder = "../train_data_xyz/salsa_6d/"
dance_frame_rate=60
batch=32
