    ...
    for bvh_dance_name in bvh_dances_names:
        ...
        if(name_len>4):
            if(bvh_dance_name[name_len-4: name_len]==".bvh"):
                ...
                dance=read_bvh.get_training_data_quaternion(src_bvh_folder+bvh_dance_name)
...
generate_traindata_from_bvh("../train_data_bvh/salsa/","../train_data_xyz/salsa_quaternions/")
