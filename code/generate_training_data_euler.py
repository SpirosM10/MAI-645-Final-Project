    ...
    for bvh_dance_name in bvh_dances_names:
        ...
        if(name_len>4):
            if(bvh_dance_name[name_len-4: name_len]==".bvh"):
                ...
                dance = read_bvh.get_train_euler_data(src_bvh_folder + bvh_dance_name)
    ...
    for dance_name in dances_names:
        ...
        if(name_len>4):
            if(dance_name[name_len-4: name_len]==".npy"):
                ...
                print (len(dance2))
                read_bvh.train_to_bvh(tar_bvh_folder + dance_name + ".bvh", np.array(dance2))

#generate_traindata_from_bvh("../train_data_bvh/indian/","../train_data_xyz/indian/")
generate_traindata_from_bvh("../train_data_bvh/salsa/", "../train_data_xyz/salsa_euler/")
